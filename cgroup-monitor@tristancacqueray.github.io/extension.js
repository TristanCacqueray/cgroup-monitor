...
(function($PS) {
  "use strict";
  $PS["CgroupMetric"] = $PS["CgroupMetric"] || {};
  var exports = $PS["CgroupMetric"];
  var Data_Array = $PS["Data.Array"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_Either = $PS["Data.Either"];
  var Data_Number_Format = $PS["Data.Number.Format"];                
  var prettyTasks = function (tasks) {
      return Data_Number_Format.toString(tasks) + " tasks";
  };
  ...
  exports["prettyTasks"] = prettyTasks;
  exports["prettyCpuTime"] = prettyCpuTime;
  exports["prettyMem"] = prettyMem;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var CgroupMetric = $PS["CgroupMetric"];
  var Control_Alternative = $PS["Control.Alternative"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  ...
  var prettyCgroupInfo = function (cg) {
      return cg.name + (": " + (CgroupMetric.prettyTasks(cg.tasks) + (" " + (CgroupMetric.prettyCpuTime(cg.cpu) + (" " + CgroupMetric.prettyMem(cg.mem))))));
  };
  var getNumber = function (arr) {
      return function (pos) {
          return Control_Bind.join(Data_Maybe.bindMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Number.fromString)(Data_Array.index(arr)(pos)));
      };
  };
  var parse = (function () {
      ...
      return Data_Array.mapMaybe(function ($1) {
          return go(Data_String_Utils.words($1));
      });
  })();
...
(function($PS) {
  ...
  var getAvailableMemory = (function () {
      ...
      return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_String_Utils.words)(Gio_File.readFile("/proc/meminfo")))(function (meminfo) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Functor.map(Data_Maybe.functorMaybe)(function ($6) {
              return Data_Int.round(toGB($6));
          })(SystemdTop.getNumber(meminfo)(7)));
      });
  })();
  var main = (function () {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Maybe.fromMaybe(0))(getAvailableMemory))(function (availMem) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(SystemdTop.parse)(SystemdTop.runCgTop(SystemdTop.Memory.value)))(function (cgTop) {
                      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
                          GJS.log(availMem)();
                          Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(function ($7) {
                              return GJS.log(SystemdTop.prettyCgroupInfo($7));
