...
})(PS["Gio.Raw.Subprocess"] = PS["Gio.Raw.Subprocess"] || {});
(function($PS) {
  // Generated by purs version 0.14.1
  "use strict";
  $PS["Gio.Raw.Subprocess"] = $PS["Gio.Raw.Subprocess"] || {};
  var exports = $PS["Gio.Raw.Subprocess"];
  var $foreign = $PS["Gio.Raw.Subprocess"];
  var Data_Nullable = $PS["Data.Nullable"];
  var Data_Tuple_Nested = $PS["Data.Tuple.Nested"];
  var communicate_utf8_finish = $foreign.communicate_utf8_finish_impl(Data_Tuple_Nested.tuple3);
  var communicate_utf8_async = function (proc) {
      return function (stdin) {
          return function (cancellable) {
              return function (cb) {
                  return $foreign.communicate_utf8_async_impl(proc)(Data_Nullable.toNullable(stdin))(Data_Nullable.toNullable(cancellable))(cb);
              };
          };
      };
  };
  exports["communicate_utf8_async"] = communicate_utf8_async;
  exports["communicate_utf8_finish"] = communicate_utf8_finish;
  exports["new"] = $foreign["new"];
})(PS);
(function(exports) {
  "use strict";
...
})(PS["Gio.Raw.SubprocessFlags"] = PS["Gio.Raw.SubprocessFlags"] || {});
(function($PS) {
  // Generated by purs version 0.14.1
  "use strict";
  $PS["Gio.Raw.SubprocessFlags"] = $PS["Gio.Raw.SubprocessFlags"] || {};
  var exports = $PS["Gio.Raw.SubprocessFlags"];
  var $foreign = $PS["Gio.Raw.SubprocessFlags"];
  exports["stdout_pipe"] = $foreign.stdout_pipe;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.1
  "use strict";
  $PS["Gio.Subprocess"] = $PS["Gio.Subprocess"] || {};
  var exports = $PS["Gio.Subprocess"];
  var Data_Either = $PS["Data.Either"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Monoid = $PS["Data.Monoid"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Class = $PS["Effect.Class"];
  var Effect_Exception = $PS["Effect.Exception"];
  var Gio_Raw_Subprocess = $PS["Gio.Raw.Subprocess"];
  var Gio_Raw_SubprocessFlags = $PS["Gio.Raw.SubprocessFlags"];                
  var cmd = function (argv) {
      var runEffect = function (done) {
          var cb = function (obj) {
              return function (res) {
                  return function __do() {
                      var v = Gio_Raw_Subprocess.communicate_utf8_finish(obj)(res)();
                      if (v.value0) {
                          return done(new Data_Either.Right(v.value1.value0))();
                      };
                      return done(new Data_Either.Left(Effect_Exception.error("Oops")))();
                  };
              };
          ...
          return function __do() {
              var proc = Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Gio_Raw_Subprocess["new"](argv)(Gio_Raw_SubprocessFlags.stdout_pipe))();
              Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Gio_Raw_Subprocess.communicate_utf8_async(proc)(Data_Maybe.Nothing.value)(Data_Maybe.Nothing.value)(cb))();
              return Data_Monoid.mempty(Effect_Aff.monoidCanceler);
          };
      };
      return Effect_Aff.makeAff(runEffect);
...
(function($PS) {
  "use strict";
  $PS["SystemdTop"] = $PS["SystemdTop"] || {};
  var exports = $PS["SystemdTop"];
  var Control_Alternative = $PS["Control.Alternative"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var Effect_Aff = $PS["Effect.Aff"];
  var Gio_Subprocess = $PS["Gio.Subprocess"];                
  var Cpu = (function () {
      function Cpu() {
  ...
  var runCgTop = function (order) {
      var orderArg = (function () {
          ...
          throw new Error("Failed pattern match at SystemdTop (line 24, column 14 - line 26, column 31): " + [ order.constructor.name ]);
      })();
      var cmd = Gio_Subprocess.cmd([ "systemd-cgtop", orderArg, "--cpu=time", "-1", "--depth=10", "-P", "--raw" ]);
      return Data_Functor.map(Effect_Aff.functorAff)(Data_String_Utils.lines)(cmd);
  };
  var prettyMem = function (mem) {
      ...
      var go = function (acc) {
          return function (nextUnit) {
              if (nextUnit.sz === 0.0 || acc.value < nextUnit.sz) {
                  return Data_Either.Left.create(Data_Number_Format.toStringWith(Data_Number_Format.fixed(3))(acc.value) + (" " + acc.unit));
              };
              ...
              throw new Error("Failed pattern match at SystemdTop (line 63, column 3 - line 63, column 133): " + [ acc.constructor.name, nextUnit.constructor.name ]);
          };
      };
      return Data_Either.fromLeft("N/A")(Data_Array.foldM(Data_Either.monadEither)(go)({
          value: Data_Int.toNumber(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(mem)(1024)),
          unit: "KB"
      })(units));
  };
  var prettyCpuTime = function (cpu) {
      ...
      var go = function (acc) {
          return function (nextUnit) {
              ...
              throw new Error("Failed pattern match at SystemdTop (line 49, column 3 - line 49, column 133): " + [ acc.constructor.name, nextUnit.constructor.name ]);
          };
      };
      return Data_Either.fromLeft("N/A")(Data_Array.foldM(Data_Either.monadEither)(go)({
          value: Data_Int.toNumber(cpu),
          unit: "usec"
      })(units));
  };
  var prettyCgroupInfo = function (cg) {
      return cg.name + (": " + (Data_Show.show(Data_Show.showInt)(cg.tasks) + (" " + (prettyCpuTime(cg.cpu) + (" " + prettyMem(cg.mem))))));
  };
  ...
  var parse = (function () {
      var pretty = function (path) {
          return Data_Array.last(Data_String_Common.split("/")(path));
      };
      var isGlobalScope = function (path) {
          return Data_String_Utils.endsWith(".slice")(path) || (Data_String_Utils.endsWith("/container")(path) || Data_String_Utils.endsWith("user@1000.service")(path));
      };
      var go = function (xs) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(xs)(0))(function (path) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(getNumber(xs)(1))(function (tasks) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(getNumber(xs)(2))(function (cpu) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(getNumber(xs)(3))(function (mem) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Data_Maybe.bindMaybe)(Control_Alternative.guard(Data_Maybe.alternativeMaybe)(!isGlobalScope(path)))(function () {
                              return Control_Bind.bind(Data_Maybe.bindMaybe)(pretty(path))(function (name) {
      ...
      return Data_Array.mapMaybe(function ($5) {
          return go(Data_String_Utils.words($5));
      });
  })();
  exports["Memory"] = Memory;
  exports["runCgTop"] = runCgTop;
  exports["prettyCgroupInfo"] = prettyCgroupInfo;
...
(function($PS) {
  ...
  var getAvailableMemory = (function () {
      ...
      return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_String_Utils.words)(Gio_File.readFile("/proc/meminfo")))(function (meminfo) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Functor.map(Data_Maybe.functorMaybe)(toGB)(SystemdTop.getNumber(meminfo)(7)));
      });
  })();
  var main = (function () {
      if (GJS.argv.length === 1 && GJS["argv"][0] === "--run") {
          var go = function (loop) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Maybe.fromMaybe(0))(getAvailableMemory))(function (availMem) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(SystemdTop.parse)(SystemdTop.runCgTop(SystemdTop.Memory.value)))(function (cgTop) {
                      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
                          GJS.log(availMem)();
                          Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(function ($6) {
                              return GJS.log(SystemdTop.prettyCgroupInfo($6));
                          })(Data_Array.take(10)(cgTop))();
      ...
      return function __do() {
          ...
          Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(getAvailableMemory)(function (avail) {
              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                  ...
                  throw new Error("Failed pattern match at CgroupMonitor (line 38, column 18 - line 40, column 47): " + [ avail.constructor.name ]);
              })());
          }))();
          return true;
      };
